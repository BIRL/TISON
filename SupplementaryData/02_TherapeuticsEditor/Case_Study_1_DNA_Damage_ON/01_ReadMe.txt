The weight-based network, mutation files, and cell fate classification has been adapted from the work of Choi et al. (Reference: Choi M, Shi J, Jung SH, Chen X, Cho K. Attractor Landscape Analysis Reveals Feedback Loops in the p53 Network That Control the Cellular Response to DNA Damage. 2012;5(November)).
...
06_Cell Fate Classification: Contains a .csv file which has all the cell fates associated with the nodes as given in the network of Choi et al. to study 'p53 Network' in MCF-7 cell lines.
